    ...
    <div class="hidden lg:flex flex-col w-5/12 text-white p-12 relative overflow-hidden" style="background-color: #1A3B0A">
      ...
      <div class="relative flex-1">
        ...
        <p class="text-sm mb-10 leading-relaxed" style="color: #A8C890">
          {{ isRegister
            ? "Créez votre compte pour accéder à des centaines d'évènements tech, design et business."
            : 'Connectez-vous pour accéder à votre espace et vos évènements favoris.' }}
        </p>
      ...
      <div class="max-w-md w-full mx-auto">
        ...
        <div class="lg:hidden flex items-center gap-2 mb-8">
          <RouterLink to="/" class="flex items-center gap-2">
            ...
            <span class="text-gray-900" style="font-weight: 800; font-size: 1.1rem">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div v-if="isRegister">
              ...
              <div :class="inputWrapClass('confirm')">
                <Lock :size="15" class="text-gray-400 shrink-0" />
                <input v-model="form.confirm" :type="showPassword ? 'text' : 'password'" placeholder="••••••••"
                  class="flex-1 bg-transparent outline-none text-sm text-gray-800 placeholder-gray-400"
            ...
            <div v-if="!isRegister" class="text-right">
              <button type="button" class="text-xs hover:underline" style="color: #7A9E6E">
                Mot de passe oublié ?
              </button>
            </div>
          ...
          <p v-if="isRegister" class="text-xs text-gray-400 text-center mt-4">
            ...
            <a href="#" class="hover:underline" style="color: #7A9E6E">conditions</a> et notre
            <a href="#" class="hover:underline" style="color: #7A9E6E">politique de confidentialité</a>.
          </p>
        </div>
      </div>
    </div>
...
// Props : le parent (LoginView ou RegisterView) passe le mode initial
...
const isRegister = ref(props.defaultMode === 'register')
...
// Quand le parent change (ex: navigation /connexion → /inscription), on sync le mode
...
function switchMode(value: boolean) {
  ...
  router.replace({ name: value ? 'register' : 'login' })
  resetForm()
}
